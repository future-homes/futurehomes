        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className="text-2xl font-bold text-white">Future Homes</div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/properties/upload" className="hover:text-white transition">
                  List Property
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/properties?propertyType=apartment" className="hover:text-white transition">
                  Apartments
                </Link>
              </li>
              <li>
                <Link href="/properties?propertyType=house" className="hover:text-white transition">
                  Houses
                </Link>
              </li>
              <li>
                <Link href="/properties?propertyType=villa" className="hover:text-white transition">
                  Villas
                </Link>
              </li>
              <li>
                <Link href="/properties?propertyType=commercial" className="hover:text-white transition">
                  Commercial
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span>Marine Drive, Kochi<br />Kerala 682031, India</span>
              </li>
